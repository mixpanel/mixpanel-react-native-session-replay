...
### Features
- wireframes (beta) ([#81](https://github.com/mixpanel/mixpanel-react-native-session-replay/pull/81))

[Full Changelog](https://github.com/mixpanel/mixpanel-react-native-session-replay/compare/v1.3.0...v1.4.0)
